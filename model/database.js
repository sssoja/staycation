...
con.connect(function(err) {
    ...
    "CREATE TABLE users ( id integer PRIMARY KEY, email nvarchar(255) UNIQUE NOT NULL, phone_number integer UNIQUE, num_country_code integer, name nvarchar(255), preferred_contact_method varchar(255) ); " +
